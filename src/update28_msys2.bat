...
set CB_DEVEL_RESDIR=devel28_msys2\share\CodeBlocks
set CB_OUTPUT_RESDIR=output28_msys2\share\CodeBlocks

if not exist output28_msys2 md output28_msys2\
if not exist output28_msys2\share md output28_msys2\share\
...
if not exist devel28_msys2 md devel28_msys2\
if not exist devel28_msys2\share md devel28_msys2\share\
...
copy /y devel28_msys2\*.exe output28_msys2 > nul
copy /y devel28_msys2\*.dll output28_msys2 > nul
copy /y %CB_DEVEL_RESDIR%\plugins\*.dll %CB_OUTPUT_RESDIR%\plugins > nul

echo Stripping debug info from output tree
strip output28_msys2\*.exe
strip output28_msys2\*.dll
